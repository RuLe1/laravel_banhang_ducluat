...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<meta property="og:site_name" content="E-Closet" />
				...
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<div class="search_box pull-right">
							<input type="text"class="input_key"name="keywords_submit" placeholder="Tìm kiếm sản phẩm"autocomplete="off">
							<input type="submit"class="btn btn-info" name="search_items"value="Tìm kiếm">
						</div>
						</form>
					</div>
				</div>
						...
						<div class="brands_products">
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<li><a href="{{URL::to('/thuong-hieu-san-pham/'.$brand->id)}}"><span class="pull-right">(50)</span>{{$brand->brand_name}}</a></li>									
								</ul>
							</div>
							@endforeach
						</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
            $('.send_order').click(function(){
				swal({
					title: "Xác nhận bạn mua hàng?",
					text: "Đơn hàng sẽ không được trả lại, bạn có muốn đặt không?",
					type: "warning",
						...
						if(isConfirm){
							...
							$.ajax({
								...
								data:{shipping_name:shipping_name,
									...
									_token:_token},
								success:function(){
									swal("Xong!", "Đơn hàng đã được đặt thành công", "success");
								}
							});	
	...
	<script type="text/javascript">	
		$(document).ready(function(){	
			$('.calculate_delivery').click(function(){
				...
				var _token = $('input[name="_token"]').val();
				if(matp == ''&& maqh == '' && xaid == ''){
					alert('Làm ơn chọn địa chỉ đầy đủ để tính phí vận chuyển');
				}else{
					$.ajax({
